...
def realidad_aumentada():
    imagenes = {
        0: cv2.imread('imagenes/burro.jpg'),
        1: cv2.imread('imagenes/caballo.jpg'),
        2: cv2.imread('imagenes/cerdo.jpg'),
        3: cv2.imread('imagenes/perro.jpg'),
        4: cv2.imread('imagenes/gato.jpg'),
        5: cv2.imread('imagenes/vaca.jpg')
    }
